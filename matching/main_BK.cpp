...
int main(int argc, char *argv[]) {
    ...
    int k;
    // while (input >> L >> R) {        snap
    // while (input >> L >> R >> k) {   kcore
    while (input >> L >> R) {
        // cout << "Query: " << L << " " << R << " ";
        assert(L < K);
        assert(R < K);
    ...
    RES:
        ...
        for (auto one : lres) {
            ...
            // cout << g->edges[g->e].s << " " << g->edges[g->e].t << endl;
            g->e++;
        }
        ...
        // }
        // std::cout << "  ----------------------------------------------Res: " << lres.cardinality() << std::endl;
        // if (CNT == 15) {
